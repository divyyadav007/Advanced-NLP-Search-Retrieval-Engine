...
class DocumentMetadata(BaseModel):
    ...
    custom_attributes: Dict[str, Any] = Field(default_factory=dict, description="Extensible metadata attributes.")
...
class ChunkMetadata(DocumentMetadata):
    ...
    chunk_index: int = Field(..., ge=0, description="Sequential index of chunk inside parent document.")
